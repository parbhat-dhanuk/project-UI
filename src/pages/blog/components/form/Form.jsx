...
<div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
            ...
            type="text" name="category" placeholder="Category*" required />
				...
				<div className="my-4">
					<textarea placeholder="Description*" name="description" className="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
				</div>
